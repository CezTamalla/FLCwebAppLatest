...
<body>
    ...
    <div class="navbar-collapse collapse" id="navbarCustom">
        ...
        <div class="cart-list">
            <asp:GridView ID="GridViewCart" runat="server" DataKeyNames="Cart_ID" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal"  >
                <Columns>
