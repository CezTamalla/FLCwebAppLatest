<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderStatus.aspx.cs" Inherits="FLCwebApp.orderStatus" %>
...
<body>
    ...
    <div class="navbar-collapse collapse" id="navbarCustom">
        ...
        <asp:Label ID="statuslbl" runat="server" Text="Order Status"></asp:Label>
                <div class="orders-list">
            <asp:GridView ID="GridViewOrderStatus" runat="server" DataKeyNames="" AutoGenerateColumns="False" OnRowDataBound="GridViewOrderStatus_RowDataBound"  >
                <Columns>
                    <asp:TemplateField HeaderText="Oder ID">
                        <HeaderStyle CssClass="hidden" />
                        <ItemStyle CssClass="hidden" />
                        <ItemTemplate>
                            <asp:Label ID="orderID" runat="server" Text='<%#Bind("order_id","{0:00000}") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
